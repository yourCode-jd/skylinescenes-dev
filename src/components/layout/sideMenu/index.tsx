    ...
    <div className="h-full flex items-center">
      ...
      {open && (
        <div className="fixed inset-0 z-40 flex">
          ...
          {/* Drawer */}
          <div className="relative flex flex-col w-3/4 sm:w-1/3 lg:w-1/4 h-full bg-white dark:bg-gray-900 text-gray-900 dark:text-white p-6 z-50">
            {/* Close Button */}
            ...
            <ul className="flex flex-col gap-2 mb-auto">
              {navLinks.map((link, index) => (
                ...
                >
                  ...
                  {link.subMenu && (
                    <ul
                      className={`transition duration-300 overflow-hidden sm:group-hover:block ${activeIndex === index
